<template>
	<div class="photoBank-item col-6 col-md-4 col-lg-3 px-0">
        ...
        <div class="cover">
            ...
            <a href="#" class="actionLink" v-on:click="showImgPreview = true"><img src="../../assets/images/viewLink.png" alt=""> Просмотреть</a>
        </div>
        <imgPreview v-if="showImgPreview" @close="showImgPreview = false" :imgOriginal="thumbnail"></imgPreview>
    </div>
</template>
<script>
